...
//   const [carPositionArray, setCarPositionArray] = useState([{ x: 0, y:0, z: 0 }]);
...
//         if (event.key === 'p') {
//           const exportData = JSON.stringify(carPositionArray);
//           const exportBlob = new Blob([exportData], { type: 'application/json' });
//           const url = URL.createObjectURL(exportBlob);

//           // Prompt the user with a confirmation dialog
//           const shouldDownload = window.confirm('Do you want to download the carPositionArray as JSON?');
